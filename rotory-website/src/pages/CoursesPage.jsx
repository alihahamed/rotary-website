                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            ...
                            <div className="text-center p-4 bg-red-50 rounded-lg">
                                ...
                                <h4 className="font-bold text-red-800 font-merri mb-2">Modern Library</h4>
                            ...
                            <div className="text-center p-4 bg-yellow-50 rounded-lg">
                                ...
                                <h4 className="font-bold text-yellow-800 font-merri mb-2">State-of-the-Art Labs</h4>
                                <p className="text-sm text-gray-600 font-nuno">Advanced laboratories for Physics, Biology, Chemistry, and Computer Science</p>
                            </div>
                        </div>
                    </div>
                </div>
