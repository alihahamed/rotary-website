  ...
  return (
    <div className="w-full bg-white relative">
      <SEOHead
        ...
        description="Explore photo and video highlights from Rotary Pre-University College ΓÇö orientations, annual day, cultural events, sports achievements, and campus life in Hubli-Dharwad."
      />
      {/* Grid Background */}
      <div
                ...
                {[9, 10, 11, 12, 13, 14, 15, 16].map((id) => (
                  ...
                  >
                    <div className="text-center text-gray-600 p-4">
                      <div className="text-3xl mb-2">≡ƒÄô</div>
                        ...
                        <>
                          ...
                          <div className="absolute inset-0 bg-black/30 opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-center justify-center cursor-pointer">
                            <div className="bg-white/20 backdrop-blur-sm rounded-full p-4 hover:bg-white/30 transition-colors">
                              <div className="text-white text-3xl">Γû╢∩╕Å</div>
                            </div>
                          </div>
