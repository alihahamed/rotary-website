      ...
      >
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
          ...
          <div className="text-center mb-8 md:mb-12">
            ...
            <motion.div
              className="w-24 h-1 bg-red-700 mx-auto mt-4"
              initial={{ scaleX: 0 }}
              animate={{ scaleX: 1 }}
          ...
          >
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              >
                ...
                <motion.div
                  className="w-16 h-1 bg-blue-700 mx-0 mt-2"
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
                ...
                <div className="bg-white/50 rounded-lg p-4">
                  <p className="text-gray-700 leading-relaxed font-nuno text-base md:text-lg">
                    The Admission commences immediately after the announcement
                    of S.S.L.C results.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <motion.div
                  className="w-16 h-1 bg-yellow-500 mx-0 mt-2"
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
                ...
                <div className="bg-white/50 rounded-lg p-4">
                  <p className="text-gray-700 leading-relaxed font-nuno text-base md:text-lg mb-4">
                    Candidates who wish to take admission should contact the
                    Principal/Admission office personally along with
                    parent/guardian.
                  </p>
                  <p className="text-gray-700 leading-relaxed font-nuno text-base md:text-lg">
                    They should bring completely filled application form along
                    with four passport size photographs and a statement of marks
                    obtained in S.S.L.C Examination duly attested by the
              ...
              >
                ...
                <motion.div
                  className="w-16 h-1 bg-red-600 mx-0 mt-2"
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
                ...
                <div className="bg-white/50 rounded-lg p-4">
                  <p className="text-gray-700 leading-relaxed font-nuno text-base md:text-lg mb-4">
                    The documents to be submitted in original to the college
                    office:
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-red-600 rounded-full mt-3 mr-4 flex-shrink-0"></span>
                      <span className="text-gray-700 font-nuno text-base md:text-lg">
                        Marks card of S.S.L.C or equivalent exam marks card with
                        a Xerox copy
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-red-600 rounded-full mt-3 mr-4 flex-shrink-0"></span>
                      <span className="text-gray-700 font-nuno text-base md:text-lg">
                        Transfer certificate issued by the institution last
                        attended with a Xerox copy
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-red-600 rounded-full mt-3 mr-4 flex-shrink-0"></span>
                      <span className="text-gray-700 font-nuno text-base md:text-lg">
                        Conduct certificate issued by the institution last
                        attended with a Xerox copy
                      </span>
                    </li>
                    ...
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-red-600 rounded-full mt-3 mr-4 flex-shrink-0"></span>
                      <span className="text-gray-700 font-nuno text-base md:text-lg">
                        Caste Certificate issued by the Tahasildhar with a Xerox
                        copy
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-red-600 rounded-full mt-3 mr-4 flex-shrink-0"></span>
                      <span className="text-gray-700 font-nuno text-base md:text-lg">
                        Income Certificate with a Xerox copy{" "}
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              >
                ...
                <div className="bg-white/50 rounded-lg p-4">
                  <p className="text-gray-700 leading-relaxed font-nuno text-base md:text-lg">
                    Application form with Prospectus can be obtained from the
                    College or Admission Office.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-yellow-800 font-nuno text-base md:text-lg font-semibold">
                    All admissions are provisional and are subject to final
                    approval by the Dept. of P.U. Education, Govt. of Karnataka.
                  </p>
                </div>
              </motion.div>
            </div>
