        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-700 font-nuno text-base">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
                  ...
                  >
                    ...
                    <div className="opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 delay-100">
                      <p className="text-gray-700 font-nuno text-lg leading-relaxed">
                        State-of-the-art science labs, smart classrooms, and
                        advanced facilities designed for optimal learning
                        experiences.
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 delay-100">
                      <p className="text-gray-700 font-nuno text-base leading-relaxed">
                        Nurturing leadership, creativity, and social
                        responsibility through comprehensive extracurricular
                        programs.
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 delay-100">
                      <p className="text-gray-700 font-nuno text-sm leading-relaxed">
                        Qualified teachers providing personalized mentorship and
                        academic guidance.
                      </p>
                    </div>
                  </motion.div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 delay-100">
                      <p className="text-gray-700 font-nuno text-sm leading-relaxed">
                        Comprehensive guidance for university admissions and
                        career planning.
                      </p>
                    </div>
                  </motion.div>
          ...
          <div className="mt-12 md:mt-16">
            <div className="text-center mb-8 md:mb-12">
              ...
              <div className="w-24 h-1 bg-blue-600 mx-auto mt-4"></div>
              <p className="text-lg md:text-xl text-gray-600 mt-4 font-nuno">
                Meet the dedicated professionals who make Rotary PU College
                exceptional
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed font-nuno text-base md:text-lg">
                  Our experienced and qualified faculty members are committed to
                  providing quality education and nurturing the potential of
                  every student.
                </p>
              </motion.div>
              ...
              >
                ...
                />
                <p className="text-gray-700 leading-relaxed font-nuno text-base md:text-lg">
                  Our dedicated support staff works tirelessly behind the scenes
                  to ensure a smooth and conducive learning environment for all
                  students.
                </p>
              </motion.div>
            </motion.div>
