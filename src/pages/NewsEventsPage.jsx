...
function NewsEventsPage() {
  ...
  const getCategoryColor = (category) => {
    ...
    return (
      colors[category] ||
      "bg-gradient-to-r from-[#6b7280] via-[#9ca3af] to-[#d1d5db]"
    );
  };
      ...
      <section className="py-12 md:py-16 relative z-10" id="newsEvents">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
          ...
          >
            ...
            >
              Stay updated with the latest news and announcements at Rotary PU
              College
            </motion.p>
          </motion.div>
          ...
          >
            {newsData.map((news, index) => (
              ...
              >
                ...
                <span
                  className={`indicator-item badge text-white font-semibold p-2  md:p-3 absolute right-7 md:right-4 text-xs md:text-sm font-nuno border-1 border-black ${getCategoryColor(news.category)}`}
                >
                  {news.category}
                </span>
